...
type
 ...
 function CreateLight(type_:longint; position, target: TVector3; color: TColor; shader: TShader): TLight; // Create a light and get shader locations
...
var lightsCount: longint = 0;    // Current amount of created lights
  ...
  function CreateLight(type_: longint; position, target: TVector3; color: TColor;
