...
make PLATFORM=PLATFORM_MEMORY GRAPHICS=GRAPHICS_API_OPENGL_SOFTWARE RAYLIB_MODULE_RAYGUI=TRUE
...
make PLATFORM=PLATFORM_MEMORY GRAPHICS=GRAPHICS_API_OPENGL_SOFTWARE RAYLIB_MODULE_RAYGUI=TRUE OS=Windows_NT CC=x86_64-w64-mingw32-gcc AR=x86_64-w64-mingw32-ar 
